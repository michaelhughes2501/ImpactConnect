# CLAUDE.md — client/src/components/

App-specific React components (header, bottom-navigation, profile-card, match-modal, safety-banner, sentence-calculator). UI primitives live in `ui/`.
